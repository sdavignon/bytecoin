...
const char     CRYPTONOTE_NAME[]                             = "stealthiscoin";
...
const int      P2P_DEFAULT_PORT                              =  19765;
const int      RPC_DEFAULT_PORT                              =  19764;
...
const char* const SEED_NODES[] = {
  "seed.riffcash.org:19765",
  "seed.riffcash.com:19765"
};
